...
void main() async {
  ...
  await NotificationsBloc.initializeFMC();
...
class HandleNotificationInterations extends StatefulWidget {
  ...
  final Widget child;
  const HandleNotificationInterations({
    super.key,
    required this.child
  });

  @override
  State<HandleNotificationInterations> createState() => _HandleNotificationInterationsState();
}

class _HandleNotificationInterationsState extends State<HandleNotificationInterations> {
